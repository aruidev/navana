    ...
    <div class="page-section">
        <div class="form-wrapper border card-like" style="text-align:center;">
            ...
            <div class="form-actions" style="justify-content:center;">
                <a class="primary-btn ghost-btn" href="<?= htmlspecialchars(buildRouteUrl('home')) ?>">Go to Home</a>
                <a class="ghost-btn" href="<?= htmlspecialchars(buildRouteUrl('login')) ?>">Log In</a>
            </div>
        </div>
    </div>
</div>
